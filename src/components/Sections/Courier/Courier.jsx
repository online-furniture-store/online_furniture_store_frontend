...
function Courier() {
  ...
  return (
    <section className={styles.address}>
      ...
      <Address onChange={handleAdressInput} value={adress} isValid />
      <div className={styles.addressNumbers}>
        <AddressNumber onChange={handleApartamentInput} value={apartament} place="Квартира" />
        <AddressNumber onChange={handleEntranceInput} value={entrance} place="Подъезд" />
